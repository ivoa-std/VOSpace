...
Please refer to the IVOA Single-Sign-On Profile: Authentication Mechanisms for more information: \citep{2017ivoa.spec.0524T}
...
\begin{itemize}
    ...
    \item \emph{param}: A list of zero or more parameters that specify any additional arguments for the transfer.
        \begin{itemize}
            ...
            \begin{lstlisting}
<vos:param uri="ivo://ivoa.net/vospace/core#length"
   >1024</vos:param>
            \end{lstlisting}
        \end{itemize}
\end{itemize}
...
so this will also be recognized as a valid standardID for VOSpace in the 2.1 specification.
...
For a full list of authentication methods and the associated standardIDs please refer to the document: \citep{2017ivoa.spec.0524T.0}. 	
