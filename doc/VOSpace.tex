...
\begin{itemize}
    ...
    \item \begin{verbatim}ivo://ivoa.net/vospace/core#httpauth\end{verbatim} SHALL be used as the authentication type URI for HTTP userid password authentication
    \item \begin{verbagim}ivo://ivoa.net/vospace/core#x509\end{verbatim} SHALL be used as the authentication type URI for X.509 certificate authentication be used as the protocol URI for a HTTP PUT transfer
