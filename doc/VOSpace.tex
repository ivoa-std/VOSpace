...
For a full list of authentication methods and the associated standardIDs please refer to the document: \citep{std:SSOAUTH2.0}. 	
...
For all faults, the service shall set the PHASE to ``ERROR'' in the Job representation. The \verb|<errorSummary>| element in the Job representation shall be set to the appropriate value for the fault type and the appropriate fault representation (see section 5.5) provided at the error URI: http://rest-endpoint/transfers/(jobid)/error.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item e.g., \verb|<Node uri="vos://service/name" xs:type="Node"/>|
        \end{itemize}
