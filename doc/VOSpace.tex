...
3 & "!" or "~" are used consistently in VOSpace node URIs & 2 \\ \hline
4 & "!" or "~" are valid separator characters in service requests & 2 \\ \hline
...
8 & A DataNode has elements: uri, properties, capabilities, accepts, provides and busy & 3.1 \\ \hline
