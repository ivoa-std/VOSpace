...
<uws:job xmlns:uws="http://www.ivoa.net/xml/UWS/v1.0" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <uws:parameters />
  <uws:results>
    <uws:result id="transferDetails" xlink:href="http://server.example.com/vospace/xfer/zkqzpftmufdi8luh" />
...
\begin{lstlisting}
> curl -v http://www.canfar.phys.uvic.ca/vospace/xfer/zkqzpftmufdi8luh
\end{lstlisting}
Response:
\begin{lstlisting}
* About to connect() to server.exampe.com port 80 (#0)
*   Trying 132.246.217.44... connected
* Connected to server.example.com (132.246.217.44) port 80 (#0)
> GET /vospace/xfer/zkqzpftmufdi8luh HTTP/1.1
> User-Agent: curl/7.19.7 (universal-apple-darwin10.0) libcurl/7.19.7 OpenSSL/0.9.8y zlib/1.2.3
> Host: server.example.com
> Accept: */*
>
