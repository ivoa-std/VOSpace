...
\begin{itemize}
    ...
    \item ivo://ivoa.net/vospace/core\#immutable MAY be used as the property URI denoting a node whose content cannot be changed and for which moveNode and deleteNode operations are not allowed. If the node is a container node, child nodes cannot be added or removed. Children of an immutable node inherit this property. Properties that are not readOnly can still be edited
\end{itemize}
