...
\begin{tabular}{ p{10cm} }
The node to be created (newNode.xml) is:
\begin{verbatim}
...
{\indent
The Job to be submitted (newJob.xml) is:
\begin{verbatim}
<node xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
...
* Closing connection #0
\end{verbatim}
This resource can be found at http://localhost:8000/transfers/
    ec200b5ff77641fb841978a85d1f7245. 
\rule[0.5ex]{\linewidth}{1pt}
\begin{verbatim}
The status of the job can now be polled at the job location:
> curl -v "http://localhost:8000/transfers/
    ec200b5ff77641fb841978a85d1f7245"
\end{verbatim}
\rule[0.5ex]{\linewidth}{1pt}
\Huge
\begin{Verbatim}[fontsize=\scriptsize, frame=single, framesep=5mm, fontfamily=courier]
* Connected to localhost (127.0.0.1) port 8000 (#0)
