...
A VOSpace service can support, as an OPTIONAL feature, immutable nodes. Content of immutable nodes can't be changed and they are identified by adding the standard property ivo://ivoa.net/vospace/core\#immutable set to true.
...
\begin{itemize}
    ...
    \item ivo://ivoa.net/vospace/core\#immutable MAY be used as the property URI denoting a node whose content cannot be changed and for which moveNode and deleteNode operations are not allowed. See section \ref{subsubsec:immutable nodes} for details.
\end{itemize}
